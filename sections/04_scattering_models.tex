...
\emph{Consequence:} $\nu(\Delta p)$ has enhanced small-$\Delta p$ weight; CLT $\to$ near-Gaussian heating but with fat tails. This is distinct from heavy-tailed Lévy processes (Sec.~\ref{sec:heavy_tail}), which require enhanced \emph{large} momentum transfer from mechanisms like Coulomb scattering on charged grains.\\
